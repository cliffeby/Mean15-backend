...
router.post('/', requireMinRole('admin'), createScorecard); // Create new scorecard (admin only)
router.put('/:id', requireMinRole('admin'), updateScorecard); // Update scorecard (admin only)
